...
import {Loader, PrimaryButton} from '@/shared/ui';
import {DownToUp, FadeIn, Hover, LeftToRight} from '@/shared/animations';
    ...
    return (
      <FadeIn>
        <Loader
          ...
          title={{need: true, text: 'created by', size: 16}}
          sub={true}
          iconSize={25}
        />
      </FadeIn>
    ...
    <FadeIn>
      ...
      <div className='h-screen w-full flex flex-col items-center justify-center gap-3'>
        <div className='flex flex-col items-center justify-center'>
          <LeftToRight delay={1.5}>
            <svg
              className='h-12 text-white lg:h-16 lg:text-[#FF2D20]'
              viewBox='0 0 62 65'
              fill='none'
          ...
          <DownToUp delay={0.5}>
            <p>Starter Pack Laravel + React (only frontend)</p>
          </DownToUp>
        </div>
